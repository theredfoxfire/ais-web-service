...
The API development repo: [dev-ais](https://github.com/theredfoxfire/dev-ais-api)

The client side development repo: [react-init](https://github.com/theredfoxfire/ais-web)
